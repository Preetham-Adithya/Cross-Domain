import pandas as pd                                                     #to manipulate and read save into tabular form
import spacy                                                            #performing nlp
import os                                                               #file path
...
data = pd.read_csv("news_sample.csv").head(5)

print("Dataset loaded successfully!")
print("Columns found:", data.columns.tolist(), "\n")
print(data.head(), "\n")

# Detect which column has the main text
text_column = None
